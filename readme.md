...
### install
主要用于创建Vue插件。
1.创建：第一个参数是Vue构造器；第二个参数是配置对象，可选。
2.使用：使用Vue.use(插件名)来使用插件，并会自动阻止多次注册相同插件
[源码地址](https://github.com/vue-resource/vue-component/blob/master/resource/view/Vue.install.html)
